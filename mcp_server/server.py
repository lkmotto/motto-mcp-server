...
from .tools import create_epic, dispatch_droid_for_epic, epic_status, pause_epic, kill_epic, list_all_services, find_orphans, archive_service, consolidation_audit
...
# Epic control plane tools (Day-0 bootstrap) -- imported from mcp_server.tools

mcp.tool(create_epic)
mcp.tool(dispatch_droid_for_epic)
mcp.tool(epic_status)
mcp.tool(pause_epic)
mcp.tool(kill_epic)
mcp.tool(list_all_services)
mcp.tool(find_orphans)
mcp.tool(archive_service)
mcp.tool(consolidation_audit)
